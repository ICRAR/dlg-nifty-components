...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=dlg_nifty_components -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "v$${TAG}" > dlg_nifty_components/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add dlg_nifty_components/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "dlg_nifty_components = 'dlg_nifty_components.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run dlg_nifty_components'"
