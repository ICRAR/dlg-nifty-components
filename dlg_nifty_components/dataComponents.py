"""
dlg_nifty_components component module.

This is the module of dlg_nifty_components containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/dlg_nifty_components.MyData/String/readonly/
