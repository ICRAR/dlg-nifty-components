"""
dlg_nifty_components appComponent module.

This is the module of dlg_nifty_components containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/dlg_nifty_components.MyApp/String/readonly/
